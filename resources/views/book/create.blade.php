@extends('layouts.bookapp', ['title' => 'Tambah Post'])
...
<div class="container mx-auto mt-10 mb-10">
    <div class="bg-white p-5 rounded shadow-sm">
        <form action="{{ route('book.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-5">
                <button type="submit"
                    class="bg-green-500 text-white p-2 rounded shadow-sm focus:outline-none hover:bg-indigo-700">SIMPAN BOOK</button>
            </div>
